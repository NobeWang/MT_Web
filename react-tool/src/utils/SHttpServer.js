...
//
game.HttpServer = engine.Object.extends({
    ...
    start: function () {
        ...
        httpServer.listen(port, function () {
            engine.Logger.info("[HttpServer][Start]", "runing at http://" + ip + ":" + port + "/");
    ...
    processRequest: function (request, response) {
        ...
        if (path.extname(pathName) === '') {
            ...
            pathName += this.config.defaultPage;
            hasExt = false; //标记默认页面是程序自动添加的
        }

        //获取资源文件的相对路径
        var filePath = path.join(this.config.webroot, pathName);
